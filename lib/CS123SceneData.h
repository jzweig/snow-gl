...
//! Data for a single intersect.
struct CS123SceneIntersect
{
   bool isValid; //! true if an intersection has occured
   REAL dist; //! distance from the camera
   Vector4 pos; //! position of the intersection
   Vector4 norm; //! normal of the intersection
   PrimitiveType type; //! type of object intersecting with
   CS123SceneObject* obj; //! object intersecting with
};
