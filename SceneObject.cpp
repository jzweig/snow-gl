...
void SceneObject::recordSnowfall(Vector4 objPosition){
    ...
    //increment snowmap;
    int incr = 10;
    data[ycoord*m_displacementResolution+xcoord].r = min(data[ycoord*m_displacementResolution+xcoord].r+incr,255);
    data[ycoord*m_displacementResolution+xcoord].g = min(data[ycoord*m_displacementResolution+xcoord].g+incr,255);
    data[ycoord*m_displacementResolution+xcoord].b = min(data[ycoord*m_displacementResolution+xcoord].b+incr,255);
